...
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "5240924887 5702090002").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="8021957130:AAE-6wO_zO9YTeYj2BUNO2LoP7p_gDlV-YI",    
   api_id= 20531922,    
   api_hash= "1281c125a3e908948a9a64a58099a2f3"
)
